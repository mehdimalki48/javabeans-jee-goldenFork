...
public class User implements Serializable {
	...
	public User(int user_id, String full_name, String contact, String email_address, String username, String password,
			Set<Order> orders, Set<Payment> payments, Set<SiteInfo> site_infos) {
		super();
